...
col1,col2 = st.columns(2)
col1.metric(label='온도',value='22℃',delta='1.2℃',
          delta_color='normal') # normal이 디폴트임
col2.metric(label='풍속',value='9mph',delta='-8%',
            delta_color = 'normal')
...
st.area_chart(df,y=['A','B','C'],color=['#ff0033',
                                        '#009933',
                                        '#000066'])
...
# 그림영역이 fig 실제 그리고 축이 ax
fig, ax = plt.subplots()
# fig.hist(df.A) 이건 안되네...?
ax.hist(df.A)
st.pyplot(fig)
